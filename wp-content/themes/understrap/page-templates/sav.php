...
<div class="container-fluid">
    <div class="row sav-main-img" style="background-image:url(<?= get_the_post_thumbnail_url(); ?>)">
        <div class="col-6 offset-6  quote position-relative">
            <div class="row">
                <p class="position-absolute">"Faire simple est probablement l’objectif le plus sophistiqué du monde"</p>
            </div>
            <div class="row col-2 offset-10">
                <p class="author position-absolute">Steve Jobs</p>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12 bg-white main">
            <div class="container">
                ...
                <div class="row mt-2 ">
                    <div class="col-lg-6 sav-card p-5">
                    ...
                    <div class="col-lg-6 sav-card mx-auto p-5">
